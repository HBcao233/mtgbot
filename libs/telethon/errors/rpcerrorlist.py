...
class AdminIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified admin ID is invalid' + self._fmt_request(self.request)
    )
...
class AdminRankEmojiNotAllowedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Emoji are not allowed in admin titles or ranks' + self._fmt_request(self.request)
    )
...
class AlbumPhotosTooManyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Too many photos were included in the album' + self._fmt_request(self.request)
    )
...
class ApiIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The api_id/api_hash combination is invalid' + self._fmt_request(self.request)
    )
...
class AuthTokenInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'An invalid authorization token was provided' + self._fmt_request(self.request)
    )
...
class AuthTokenInvalidxError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified auth token is invalid' + self._fmt_request(self.request)
    )
...
class BotsTooMuchError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'There are too many bots in this chat/channel' + self._fmt_request(self.request)
    )
...
class BotCommandInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified command is invalid' + self._fmt_request(self.request)
    )
...
class BotGamesDisabledError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Bot games cannot be used in this type of chat' + self._fmt_request(self.request)
    )
...
class BotPollsDisabledError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You cannot create polls under a bot account' + self._fmt_request(self.request)
    )
...
class BotScoreNotModifiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "The score wasn't modified" + self._fmt_request(self.request)
    )
...
class ButtonTextInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified button text is invalid' + self._fmt_request(self.request)
    )
...
class ChannelsTooMuchError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You have joined too many channels/supergroups' + self._fmt_request(self.request)
    )
...
class ChannelIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified supergroup ID is invalid' + self._fmt_request(self.request)
    )
...
class ChannelParicipantMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The current user is not in the channel' + self._fmt_request(self.request)
    )
...
class ChatIdGenerateFailedError(ServerError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Failure while generating the chat ID' + self._fmt_request(self.request)
    )
...
class ChatSendGameForbiddenError(ForbiddenError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "You can't send a game to this chat" + self._fmt_request(self.request)
    )
...
class ChatSendInlineForbiddenError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You cannot send inline results in this chat' + self._fmt_request(self.request)
    )
...
class ChatSendPollForbiddenError(ForbiddenError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "You can't send polls in this chat" + self._fmt_request(self.request)
    )
...
class ConnectionAppVersionEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'App version is empty' + self._fmt_request(self.request)
    )
...
class ContactAddMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Contact to add is missing' + self._fmt_request(self.request)
    )
...
class ContactNameEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The provided contact name cannot be empty' + self._fmt_request(self.request)
    )
...
class ContactReqMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Missing contact request' + self._fmt_request(self.request)
    )
...
class CreateCallFailedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'An error occurred while creating the call' + self._fmt_request(self.request)
    )
...
class CurrencyTotalAmountInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The total amount of all prices is invalid' + self._fmt_request(self.request)
    )
...
class EmailUnconfirmedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Email unconfirmed' + self._fmt_request(self.request)
    )
...
class EmailVerifyExpiredError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The verification email has expired' + self._fmt_request(self.request)
    )
...
class EmojiInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified theme emoji is valid' + self._fmt_request(self.request)
    )
...
class EmojiNotModifiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "The theme wasn't changed" + self._fmt_request(self.request)
    )
...
class ExpireDateInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified expiration date is invalid' + self._fmt_request(self.request)
    )
...
class FieldNameEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The field with the name FIELD_NAME is missing' + self._fmt_request(self.request)
    )
...
class FieldNameInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The field with the name FIELD_NAME is invalid' + self._fmt_request(self.request)
    )
...
class FileContentTypeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'File content-type is invalid' + self._fmt_request(self.request)
    )
...
class FileEmtpyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'An empty file was provided' + self._fmt_request(self.request)
    )
...
class FilePartTooBigError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The uploaded file part is too big' + self._fmt_request(self.request)
    )
...
class FileTitleEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'An empty file title was specified' + self._fmt_request(self.request)
    )
...
class FilterIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified filter ID is invalid' + self._fmt_request(self.request)
    )
...
class FilterTitleEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The title field of the filter is empty' + self._fmt_request(self.request)
    )
...
class FloodPremiumWaitError(FloodError):
  def __init__(self, request, capture=0):
    ...
    self.seconds = int(capture)
    super(Exception, self).__init__(
      'A wait of {seconds} seconds is required in non-premium accounts'.format(
        seconds=self.seconds
      )
      + self._fmt_request(self.request)
    )
...
class FolderIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The folder you tried to use was not valid' + self._fmt_request(self.request)
    )
...
class FromMessageBotDisabledError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "Bots can't use fromMessage min constructors" + self._fmt_request(self.request)
    )
...
class GameBotInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You cannot send that game with the current bot' + self._fmt_request(self.request)
    )
...
class GeoPointInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid geoposition provided' + self._fmt_request(self.request)
    )
...
class GifContentTypeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'GIF content-type invalid' + self._fmt_request(self.request)
    )
...
class GroupcallAlreadyDiscardedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The group call was already discarded' + self._fmt_request(self.request)
    )
...
class GroupcallForbiddenError(ForbiddenError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The group call has already ended' + self._fmt_request(self.request)
    )
...
class GroupcallInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified group call is invalid' + self._fmt_request(self.request)
    )
...
class GroupcallJoinMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "You haven't joined this group call" + self._fmt_request(self.request)
    )
...
class GroupcallNotModifiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "Group call settings weren't modified" + self._fmt_request(self.request)
    )
...
class ImportIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified import ID is invalid' + self._fmt_request(self.request)
    )
...
class InputFilterInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The search query filter is invalid' + self._fmt_request(self.request)
    )
...
class InputTextEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified text is empty' + self._fmt_request(self.request)
    )
...
class InvoicePayloadInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified invoice payload is invalid' + self._fmt_request(self.request)
    )
...
class LangCodeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified language code is invalid' + self._fmt_request(self.request)
    )
...
class LangCodeNotSupportedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified language code is not supported' + self._fmt_request(self.request)
    )
...
class LinkNotModifiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The channel is already linked to this group' + self._fmt_request(self.request)
    )
...
class MaxDateInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified maximum date is invalid' + self._fmt_request(self.request)
    )
...
class MemberOccupyPrimaryLocFailedError(ServerError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Occupation of primary member location failed' + self._fmt_request(self.request)
    )
...
class MessageTooLongError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Message was too long' + self._fmt_request(self.request)
    )
...
class MethodInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The API method is invalid and cannot be used' + self._fmt_request(self.request)
    )
...
class MinDateInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified minimum date is invalid' + self._fmt_request(self.request)
    )
...
class MsgIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The message ID used in the peer was invalid' + self._fmt_request(self.request)
    )
...
class NetworkMigrateError(InvalidDCError):
  def __init__(self, request, capture=0):
    ...
    self.new_dc = int(capture)
    super(Exception, self).__init__(
      'The source IP address is associated with DC {new_dc}'.format(new_dc=self.new_dc)
      + self._fmt_request(self.request)
    )
...
class OptionsTooMuchError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You defined too many options for the poll' + self._fmt_request(self.request)
    )
...
class PackShortNameOccupiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'A stickerpack with this name already exists' + self._fmt_request(self.request)
    )
...
class PackTitleInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The stickerpack title is invalid' + self._fmt_request(self.request)
    )
...
class ParticipantIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified participant ID is invalid' + self._fmt_request(self.request)
    )
...
class PasswordRecoveryExpiredError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The recovery code has expired' + self._fmt_request(self.request)
    )
...
class PhotoContentTypeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Photo mime-type invalid' + self._fmt_request(self.request)
    )
...
class PhotoCropFileMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Photo crop file missing' + self._fmt_request(self.request)
    )
...
class PhotoFileMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Profile photo file missing' + self._fmt_request(self.request)
    )
...
class PinnedDialogsTooMuchError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Too many pinned dialogs' + self._fmt_request(self.request)
    )
...
class PollAnswerInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'One of the poll answers is not acceptable' + self._fmt_request(self.request)
    )
...
class PollOptionDuplicateError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'A duplicate option was sent in the same poll' + self._fmt_request(self.request)
    )
...
class PollQuestionInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The poll question was either empty or too long' + self._fmt_request(self.request)
    )
...
class PostponedTimeoutError(ServerError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The postponed call has timed out' + self._fmt_request(self.request)
    )
...
class PublicKeyRequiredError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'A public key is required' + self._fmt_request(self.request)
    )
...
class QuizCorrectAnswerInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The correct answer is not an existing answer' + self._fmt_request(self.request)
    )
...
class QuizMultipleInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'A poll cannot be both multiple choice and quiz' + self._fmt_request(self.request)
    )
...
class RandomIdDuplicateError(ServerError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You provided a random ID that was already used' + self._fmt_request(self.request)
    )
...
class ReplyMarkupBuyEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Reply markup for buy button empty' + self._fmt_request(self.request)
    )
...
class ResetRequestMissingError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'No password reset is in progress' + self._fmt_request(self.request)
    )
...
class RevoteNotAllowedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You cannot change your vote' + self._fmt_request(self.request)
    )
...
class ScheduleBotNotAllowedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Bots are not allowed to schedule messages' + self._fmt_request(self.request)
    )
...
class ScheduleDateInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid schedule date provided' + self._fmt_request(self.request)
    )
...
class ScoreInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified game score is invalid' + self._fmt_request(self.request)
    )
...
class SendAsPeerInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      "You can't send messages as the specified peer" + self._fmt_request(self.request)
    )
...
class SendMessageMediaInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The message media was invalid or not specified' + self._fmt_request(self.request)
    )
...
class SettingsInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid settings were provided' + self._fmt_request(self.request)
    )
...
class ShortNameInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified short name is invalid' + self._fmt_request(self.request)
    )
...
class ShortNameOccupiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified short name is already in use' + self._fmt_request(self.request)
    )
...
class SignInFailedError(ServerError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Failure while signing in' + self._fmt_request(self.request)
    )
...
class SmsCodeCreateFailedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'An error occurred while creating the SMS code' + self._fmt_request(self.request)
    )
...
class SrpIdInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid SRP ID provided' + self._fmt_request(self.request)
    )
...
class SrpPasswordChangedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Password has changed' + self._fmt_request(self.request)
    )
...
class StartParamTooLongError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Start parameter is too long' + self._fmt_request(self.request)
    )
...
class StickerVideoBigError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified video sticker is too big' + self._fmt_request(self.request)
    )
...
class StickerVideoNodocError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You must send the video sticker as a document' + self._fmt_request(self.request)
    )
...
class SwitchPmTextEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The switch_pm.text field was empty' + self._fmt_request(self.request)
    )
...
class TakeoutRequiredError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You must initialize a takeout request first' + self._fmt_request(self.request)
    )
...
class ThemeFileInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid theme file provided' + self._fmt_request(self.request)
    )
...
class ThemeFormatInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid theme format provided' + self._fmt_request(self.request)
    )
...
class ThemeTitleInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified theme title is invalid' + self._fmt_request(self.request)
    )
...
class TitleInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified stickerpack title is invalid' + self._fmt_request(self.request)
    )
...
class TmpPasswordInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Password auth needs to be regenerated' + self._fmt_request(self.request)
    )
...
class TopicDeletedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The topic was deleted' + self._fmt_request(self.request)
    )
...
class ToLangInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified destination language is invalid' + self._fmt_request(self.request)
    )
...
class TtlMediaInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The provided media cannot be used with a TTL' + self._fmt_request(self.request)
    )
...
class TtlPeriodInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The provided TTL Period is invalid' + self._fmt_request(self.request)
    )
...
class TimedoutError(TimedOutError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Timeout while fetching data' + self._fmt_request(self.request)
    )
...
class UsageLimitInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified usage limit is invalid' + self._fmt_request(self.request)
    )
...
class UsernameNotOccupiedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The username is not in use by anyone else yet' + self._fmt_request(self.request)
    )
...
class UserAlreadyInvitedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'You have already invited this user' + self._fmt_request(self.request)
    )
...
class UserNotMutualContactError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The provided user is not a mutual contact' + self._fmt_request(self.request)
    )
...
class UserVolumeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified user volume is invalid' + self._fmt_request(self.request)
    )
...
class VideoTitleEmptyError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified video title is empty' + self._fmt_request(self.request)
    )
...
class WallpaperFileInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The given file cannot be used as a wallpaper' + self._fmt_request(self.request)
    )
...
class WallpaperMimeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified wallpaper MIME type is invalid' + self._fmt_request(self.request)
    )
...
class WebdocumentInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid webdocument URL provided' + self._fmt_request(self.request)
    )
...
class WebdocumentMimeInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Invalid webdocument mime type provided' + self._fmt_request(self.request)
    )
...
class WebdocumentSizeTooBigError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Webdocument is too big!' + self._fmt_request(self.request)
    )
...
class WebpageCurlFailedError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'Failure while fetching the webpage with cURL' + self._fmt_request(self.request)
    )
...
class WebpushTokenInvalidError(BadRequestError):
  def __init__(self, request):
    self.request = request
    super(Exception, self).__init__(
      'The specified web push token is invalid' + self._fmt_request(self.request)
    )
